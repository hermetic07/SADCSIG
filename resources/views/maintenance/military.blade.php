        ...
        <tr>
           ...
           <td>
             @if($Military->status === "active")
              <input type="checkbox" onchange="fun_status('{!!$Military -> id!!}')" class="js-switch"  data-color="#DF4747" data-secondary-color="#818181" checked=""/>
             @else
               <input type="checkbox" onchange="fun_status('{!!$Military -> id!!}')" class="js-switch"  data-color="#DF4747" data-secondary-color="#818181"/>
             @endif
           </td>
           <td>
