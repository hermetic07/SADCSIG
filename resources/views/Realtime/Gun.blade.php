			...
			<table class="table table-borderless" id="table">
				<thead>
					<tr>
						...
						<th class="text-center">Gun Type</th>
        ...
        @if($item->status !== "deleted")
          ...
          <td>{{$item->status}}</td>
					<td><button class="edit-modal btn btn-info" data-id="{{$item->id}}"
							data-name="{{$item->name}}" data-mname="{{$item->guntype}}">
        ...
        $.ajax({
            ...
            success: function(data) {
                if ((data.errors)){
                    ...
                    $('#table').append("<tr class='item" + data.id + "'><td>" + data.id + "</td><td>" + data.name + "</td><td>" + data.guntype + "</td><td>" + data.status + "</td><td><button class='edit-modal btn btn-info' data-id='" + data.id + "' data-name='" + data.name + "' data-mname='" + data.mname + "'><span class='glyphicon glyphicon-edit'></span> Edit</button> <button class='delete-modal btn btn-danger' data-id='" + data.id + "' data-name='" + data.name + "'><span class='glyphicon glyphicon-trash'></span> Delete</button></td></tr>");
                }
            },
