                 ...
                 <div class="white-box">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-sm-4 pro-list-img" style="background: url(uploads/{{$picture}}) center center / cover no-repeat;"> <span class="pro-label label label-inverse"><a class="text-white"  href="{{url('/ClientsDetails')}}"><i class="icon-info"></i>&nbsp;&nbsp;More info</a></span> </div>
                            <div class="col-sm-8">
