<div class="modal-content">
        ...
        <div class="modal-body" >
          <div class="form-group">
            ...
            <div class="col-md-9">
              <label class="from-control"><b>{{$addGuardRequest->id}}</b></label>
            </div>
          </div>
          <div class="form-group">
            <label class="control-lable col-md-4">Establishment Name:</label>
            <div class="col-md-8">
              <label class="from-control"><b>{{$establishment->name}}</b></label>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <label class="from-control"><b>{{$establishment->person_in_charge}}</b></label>
            </div>
          </div>
          <div class="form-group">
            <label class="control-lable col-md-4">Contact No:</label>
            <div class="col-md-8">
              <label class="from-control"><b>{{$establishment->contactNo}}</b></label>
            </div>
          </div>
      </div>
      <br>
