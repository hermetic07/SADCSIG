	  ...
	  $(document).ready(function(){
        ...
        $('.add-guard').on('click', function() {
            ...
            setTimeout(function() {
                ...
                var GuardInfo = "<div class='cart-item'><div class='img-wrap'><img src='" + guardimage + "'  alt='' /></div><span>" + guardname + "</span><div class='cart-item-border'></div><div class='delete-item'></div></div>";
...
<div id="wrapper">
  ...
  <nav class="navbar navbar-default navbar-static-top m-b-0">
   ...
   <div class="top-left-part"><a class="logo" href="index.html"><b><img src="plugins/images/users/logoicon2.png" height="60" alt="home" /></b><span class="hidden-xs"><img src="plugins/images/users/logotext2.png" height="40" alt="home" /></span></a>
         </div>
    <!-- /.navbar-header -->
    <!-- /.navbar-top-links -->
    <!-- /.navbar-static-side -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Deploy guards</h4> </div>
        ...
        <div class="col-lg-12">
          <div class="white-box">
              ...
              <thead>
			    ...
			    <th  data-sort-ignore="true" data-sort-initial="true" data-toggle="true" width="10px" >Establishment</th>
                              ...
                              <td>
								<div class="el-card-item">
									<div class="el-card-avatar el-overlay-1">
                             			 <a href="SecurityGuardsProfile.html"><img src="plugins/images/Clients/establishments/pup.jpg" alt="user"  class=" img-responsive"></a>
	...
	<span class="label label-rouded2 label-custom pull-right myspan" id="cnt">0</span>
        ...
        <ul class=" navbar-menu animate">
          <div id="slimtest4">
 			...
 			<button type="button" class="btn btn-block btn-info" id="deployguards"  data-toggle="modal" data-target="#Addtse"  type="button" data-toggle="modal" data-target=".bs-example-modal-sm" ><i class="fa fa-plus-circle" ></i> Deploy guards <span class="label label-rouded3 label-danger deploysecu">0</span> </button>
               		...
               		<div class="row  el-element-overlay">
						 ...
						 <!-- alert info for the count of guards to be selected -->
							<div class="alert alert-info sel "> <i class="fa fa-exclamation-circle"></i> 	 Select 10 guards  </div>
									...
									<div class="white-box">
                            			...
                            			<div class="row">
											<div class="col-md-4 col-sm-4 text-center guard_details">
											  ...
											  <span style="display: none" class="guard_name">Evander</span>
											<span style="display: none" class="location">quezon</span>
                                     		  <button type="button"  id='AddGuard'  class="btn AddGuard btn-block btn-outline btn-info add-guard" ><i class="icon-user-follow"></i> </i> Add guard</button>

												  <span class="mytooltip tooltip-effect-5">
													<button type="button" style='display:none' id='AddedGuard' class="btn AddedGuard btn-block btn-success disabled"><i class="fa fa-check"></i> </i>  <span class="tooltip-item">added</span></button>
												...
												<div class="col-md-8 col-sm-8">
										 				...
										 				<h3 class="box-title m-b-0">Evander</h3>
									...
									<div class="white-box">
                            			<div class="row">
											<div class="col-md-4 col-sm-4 text-center guard_details">
												<div class="el-card-item">
													<div class="el-card-avatar el-overlay-1">
														<a href="artist-detail.html"><img src="plugins/images/SecurityGuards/2x2 2.jpg" alt="user"  class="img-circle img-responsive"></a>
															<div class="el-overlay">
																<ul class="el-info">
											  ...
											  <!-- name of the guard to be fly to the sidebar -->
										 <span style="display: none" class="guard_name">Ernest</span>
															<span style="display: none" class="location">pureza</span>
                                     		  <button type="button"  id='AddGuard'  class="btn AddGuard btn-block btn-outline btn-info add-guard" ><i class="icon-user-follow"></i> </i> Add guard</button>
												...
												<div class="col-md-8 col-sm-8">
										 				...
										 				<h3 class="box-title m-b-0">Ernest</h3>
          ...
          <div class="modal-content">
            ...
            <div class="text-right">
             ...
             <div class="modal-footer">
              ...
              <button type="button" class="btn btn-info waves-effect waves-light" >Deploy</button>
             </div>
            </form>
          </div>
        </div>
